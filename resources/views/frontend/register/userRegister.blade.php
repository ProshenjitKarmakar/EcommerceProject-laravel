...
<head>
    <!-- head  -->
    @include('frontend.register.includes.head');
</head>

<body>
    <!-- header  -->

    @include('frontend.register.includes.header');
    ...
    <footer class="main">
        @include('frontend.register.includes.footer');
    </footer>
    <!-- Preloader Start
    ...
    <!-- Vendor JS-->
    <!-- All JS files  -->
    @include('frontend.register.includes.scripts');
</body>
